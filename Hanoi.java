...
public class BestHanoiTower
{
    public static void main(String[] args)
    {
        ...
        Queue<Integer> previousPlacements = new LabQueue<Integer>();
            ...
            if((moveCounter + 1) % 2 == 0)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if(!previousPlacements.empty() && (moveCounter + 1) / 2 == previousPlacements.peek()) //previousPlacements[placementPointer2])
                        {
                            columnToReceive = columnSecondLargest;
                            previousPlacements.dequeue();
                            /*placementPointer2++;
                        ...
                        else if((moveCounter + 3) % 4 == 0)
                        {
                            ...
                            placementPointer++;*/
                            previousPlacements.enqueue(moveCounter);
                        }
                    }
                }
            }
